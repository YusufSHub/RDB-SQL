...
Select top 20 id, name, dept_name from departments
order by id;
...
INSERT #salary
SELECT id, name, salary FROM [new_db].[dbo].[departments];

SELECT id, name, salary 
INTO #salary
FROM [new_db].[dbo].[departments];

SELECT *
FROM #salary

UPDATE [new_db].[dbo].[departments]
SET name = 'Edward'
WHERE id = 44552;